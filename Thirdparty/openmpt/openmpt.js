...
var openmpt = Target.addStaticLibrary("openmpt");
openmpt.addFiles(sources);
openmpt.addIncludePaths(["..", ".", "common", "src"]);
...
openmpt.addDefines(["DEBUG"], { configuration: "Debug" });
openmpt.addDefines(["NDEBUG"], { configuration: "Release" });
