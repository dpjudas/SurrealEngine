...
#if !defined(_MSC_VER) && !defined(MINIMP3_ONLY_SIMD) && (defined(_M_X64) || defined(_M_ARM64) || defined(__x86_64__) || defined(__aarch64__))
...
#if !defined(_MSC_VER) && defined(__ARM_ARCH) && (__ARM_ARCH >= 6) && !defined(__aarch64__)
#define HAVE_ARMV6 1
