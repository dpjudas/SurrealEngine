...
class TypeExponentiationExpression;
class TypeDivisionExpression;
class TypeRemainderExpression;
class TypeAdditionExpression;
class TypeSubtractionExpression;
class TypeStringConcatExpression;
class TypeStringSpaceConcatExpression;
class TypeDotProductExpression;
class TypeCrossProductExpression;
class TypeShiftLeftExpression;
class TypeShiftRightExpression;
class TypeUnsignedShiftRightExpression;
...
public:
	...
	virtual void expression(TypeExponentiationExpression* node) = 0;
	...
	virtual void expression(TypeStringConcatExpression* node) = 0;
	virtual void expression(TypeStringSpaceConcatExpression* node) = 0;
	virtual void expression(TypeDotProductExpression* node) = 0;
	virtual void expression(TypeCrossProductExpression* node) = 0;
	virtual void expression(TypeShiftLeftExpression* node) = 0;
	virtual void expression(TypeShiftRightExpression* node) = 0;
	virtual void expression(TypeUnsignedShiftRightExpression* node) = 0;
	...
	virtual void expression(TypeCaseInsensitiveEqualExpression* node) = 0;
	...
	virtual void expression(TypeLogicalXorXorExpression* node) = 0;
