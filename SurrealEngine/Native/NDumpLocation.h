...
public:
	...
	static void GetFirstDumpFileLocation(UObject* Self, BitfieldBool& ReturnValue);
	static void GetNextDumpFile(UObject* Self, std::string& ReturnValue);
	static void GetNextDumpFileLocation(UObject* Self, BitfieldBool& ReturnValue);
	static void GetNextDumpFileLocationID(UObject* Self, int& ReturnValue);
	static void HasLocationBeenSaved(UObject* Self, BitfieldBool& ReturnValue);
	static void LoadLocation(UObject* Self);
	static void OpenDumpFile(UObject* Self, const std::string& FileName, BitfieldBool& ReturnValue);
	static void SaveLocation(UObject* Self);
	static void SelectDumpFileLocation(UObject* Self, int dumpLocationID, BitfieldBool& ReturnValue);
