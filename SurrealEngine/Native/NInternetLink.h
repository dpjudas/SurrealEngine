...
public:
	...
	static void IsDataPending(UObject* Self, bool& ReturnValue);
	static void ParseURL(UObject* Self, const std::string& URL, std::string& Addr, int& Port, std::string& LevelName, std::string& EntryName, bool& ReturnValue);
	static void Resolve(UObject* Self, const std::string& Domain);
	static void StringToIpAddr(UObject* Self, const std::string& Str, IpAddr& Addr, bool& ReturnValue);
