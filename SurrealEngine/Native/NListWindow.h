...
public:
	...
	static void AddRow(UObject* Self, const std::string& rowStr, std::optional<int> clientData, int& ReturnValue);
	static void AddSortColumn(UObject* Self, int colIndex, std::optional<bool> bReverse, std::optional<bool> bCaseSensitive);
	static void DeleteAllRows(UObject* Self);
	static void DeleteRow(UObject* Self, int rowId);
	static void EnableAutoExpandColumns(UObject* Self, std::optional<bool> bAutoExpand);
	static void EnableAutoSort(UObject* Self, std::optional<bool> bAutoSort);
	static void EnableHotKeys(UObject* Self, std::optional<bool> bEnable);
	static void EnableMultiSelect(UObject* Self, std::optional<bool> bEnableMultiSelect);
	...
	static void HideColumn(UObject* Self, int colIndex, std::optional<bool> bHide);
	...
	static void MoveRow(UObject* Self, uint8_t Move, std::optional<bool> bSelect, std::optional<bool> bClearRows, std::optional<bool> bDrag);
	static void PlayListSound(UObject* Self, UObject* listSound, std::optional<float> Volume, std::optional<float> Pitch);
	static void RemoveSortColumn(UObject* Self, int colIndex);
	static void ResetSortColumns(UObject* Self, std::optional<bool> bSort);
	static void ResizeColumns(UObject* Self, std::optional<bool> bExpandOnly);
	static void RowIdToIndex(UObject* Self, int rowId, int& ReturnValue);
	static void SelectAllRows(UObject* Self, std::optional<bool> bSelect);
	static void SelectRow(UObject* Self, int rowId, std::optional<bool> bSelect);
	static void SelectToRow(UObject* Self, int rowId, std::optional<bool> bClearRows, std::optional<bool> bInvert, std::optional<bool> bSpanRows);
	...
	static void SetColumnType(UObject* Self, int colIndex, uint8_t newType, std::optional<std::string> newFmt);
	...
	static void SetFocusRow(UObject* Self, int rowId, std::optional<bool> bMoveTo, std::optional<bool> bAnchor);
	...
	static void SetListSounds(UObject* Self, std::optional<UObject*> ActivateSound, std::optional<UObject*> moveSound);
	static void SetNumColumns(UObject* Self, int newCols);
	static void SetRow(UObject* Self, int rowId, std::optional<bool> bSelect, std::optional<bool> bClearRows, std::optional<bool> bDrag);
	...
	static void SetSortColumn(UObject* Self, int colIndex, std::optional<bool> bReverse, std::optional<bool> bCaseSensitive);
