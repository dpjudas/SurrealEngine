...
public:
	...
	static void FindPathToward(UObject* Self, UObject* anActor, std::optional<bool> bSinglePath, std::optional<bool> bClearPaths, UObject*& ReturnValue);
	static void FindRandomDest(UObject* Self, std::optional<bool> bClearPaths, UObject*& ReturnValue);
	...
	static void MoveTo(UObject* Self, const vec3& NewDestination, std::optional<float> speed);
	static void MoveToward(UObject* Self, UObject* NewTarget, std::optional<float> speed);
	...
	static void AICanHear(UObject* Self, UObject* Other, std::optional<float> Volume, std::optional<float> Radius, float& ReturnValue);
	static void AICanSee(UObject* Self, UObject* Other, std::optional<float> Visibility, std::optional<bool> bCheckVisibility, std::optional<bool> bCheckDir, std::optional<bool> bCheckCylinder, std::optional<bool> bCheckLOS, float& ReturnValue);
	static void AICanSmell(UObject* Self, UObject* Other, std::optional<float> Smell, float& ReturnValue);
	...
	static void ComputePathnodeDistances(UObject* Self, std::optional<UObject*> startActor);
	static void LineOfSightTo_Deus(UObject* Self, UObject* Other, std::optional<bool> bIgnoreDistance, BitfieldBool& ReturnValue);
