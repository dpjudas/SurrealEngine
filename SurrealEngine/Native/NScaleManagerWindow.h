...
public:
	...
	static void SetManagerMargins(UObject* Self, std::optional<float> newMarginWidth, std::optional<float> newMarginHeight);
	static void SetManagerOrientation(UObject* Self, uint8_t newOrientation);
	static void SetMarginSpacing(UObject* Self, std::optional<float> newSpacing);
	...
	static void StretchScaleField(UObject* Self, std::optional<bool> bNewStretch);
	static void StretchValueField(UObject* Self, std::optional<bool> bNewStretch);
};
