...
public:
	...
	static void CreateIterator(UObject* Self, std::optional<uint8_t> flagType, int& ReturnValue);
	...
	static void SetBool(UObject* Self, const NameString& FlagName, bool NewValue, std::optional<bool> bAdd, std::optional<int> expiration, BitfieldBool& ReturnValue);
	static void SetByte(UObject* Self, const NameString& FlagName, uint8_t NewValue, std::optional<bool> bAdd, std::optional<int> expiration, BitfieldBool& ReturnValue);
	...
	static void SetFloat(UObject* Self, const NameString& FlagName, float NewValue, std::optional<bool> bAdd, std::optional<int> expiration, BitfieldBool& ReturnValue);
	static void SetInt(UObject* Self, const NameString& FlagName, int NewValue, std::optional<bool> bAdd, std::optional<int> expiration, BitfieldBool& ReturnValue);
	static void SetName(UObject* Self, const NameString& FlagName, const NameString& NewValue, std::optional<bool> bAdd, std::optional<int> expiration, BitfieldBool& ReturnValue);
	static void SetRotator(UObject* Self, const NameString& FlagName, const Rotator& NewValue, std::optional<bool> bAdd, std::optional<int> expiration, BitfieldBool& ReturnValue);
	static void SetVector(UObject* Self, const NameString& FlagName, const vec3& NewValue, std::optional<bool> bAdd, std::optional<int> expiration, BitfieldBool& ReturnValue);
};
