...
public:
	...
	static void ParseKillMessage_U227(const std::string& KillerName, const std::string& VictimName, const std::string& WeaponName, const std::string& DeathMessage, std::optional<bool> bFemale, std::string& ReturnValue);
	...
	static void StripColorCodes_U227(std::string& S);
};
