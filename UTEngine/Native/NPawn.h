...
public:
	...
	static void CanSee(UObject* Self, UObject* Other, bool& ReturnValue);
	static void CheckValidSkinPackage(const std::string& SkinPack, const std::string& MeshName, bool& ReturnValue);
	...
	static void FindPathTo(UObject* Self, const vec3& aPoint, bool* bSinglePath, bool* bClearPaths, UObject*& ReturnValue);
	static void FindPathToward(UObject* Self, UObject* anActor, bool* bSinglePath, bool* bClearPaths, UObject*& ReturnValue);
	static void FindRandomDest(UObject* Self, bool* bClearPaths, UObject*& ReturnValue);
	static void FindStairRotation(UObject* Self, float DeltaTime, int& ReturnValue);
	static void LineOfSightTo(UObject* Self, UObject* Other, bool& ReturnValue);
	...
	static void PickWallAdjust(UObject* Self, bool& ReturnValue);
	...
	static void actorReachable(UObject* Self, UObject* anActor, bool& ReturnValue);
	static void pointReachable(UObject* Self, const vec3& aPoint, bool& ReturnValue);
};
