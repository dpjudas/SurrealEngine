...
LRESULT CALLBACK SurrealGPUWindowProc(HWND hwnd, UINT msg, WPARAM wparam, LPARAM lparam)
{
...
int APIENTRY WinMain(HINSTANCE hInst, HINSTANCE hInstPrev, PSTR cmdline, int cmdshow)
{
	...
	try
	{
		...
		classdesc.lpszClassName = L"SurrealGPUWindow";
		classdesc.lpfnWndProc = &SurrealGPUWindowProc;
		...
		hwnd = CreateWindowEx(WS_EX_OVERLAPPEDWINDOW, L"SurrealGPUWindow", L"SurrealGPU Example", WS_OVERLAPPEDWINDOW | WS_VISIBLE, 0, 0, 1280, 1024, 0, 0, GetModuleHandle(nullptr), nullptr);
		if (!hwnd)
