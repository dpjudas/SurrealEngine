...
**The full measurement — counts, per-class stub lists for both games, and the method to re-run it — was in
`Docs/VMConformance.md`, since retired; its findings live on as BUG-070/072/076-081 below and in
[`Docs/NonVR-Bugs-Open.md`](Docs/NonVR-Bugs-Open.md).** This section is the summary and the resulting work.
...
method to re-run it — was in `Docs/VMConformance.md` (since retired; see `Bugtracker.md` RP-2 above and
[`Docs/NonVR-Bugs-Open.md`](Docs/NonVR-Bugs-Open.md) for the surviving findings).
